...
class TestExtendedDict:
    ...
    def test_get_condition_valid(self):
        ploc = self.map.ploc
    ...
    def test_get_condition_invalid(self):
        ...
        with pytest.raises(SyntaxError):
            ploc._get_condition("invalid_condition")
    ...
    def test_extract_int_keys_empty(self):
        empty_map = ExtendedDict()
        result = empty_map.ploc._extract_int_keys()
        assert result == []

    def test_extract_by_condition_valid(self):
        ploc = self.map.ploc
    ...
    def test_extract_by_condition_invalid(self):
        ploc = self.map.ploc
